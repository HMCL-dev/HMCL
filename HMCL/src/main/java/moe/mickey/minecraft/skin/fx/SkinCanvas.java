...
public class SkinCanvas extends Group {
    ...
    public static final Image ALEX = FXUtils.newBuiltinImage("/assets/img/skin/alex.webp");
    public static final Image STEVE = FXUtils.newBuiltinImage("/assets/img/skin/steve.webp");
