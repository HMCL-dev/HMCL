...
public final class Metadata {
    ...
    public static final String NAME = "Infernum Launcher";
    public static final String FULL_NAME = "Infernum Launcher";
    public static final String VERSION = System.getProperty("hmcl.version.override", JarUtils.getAttribute("hmcl.version", "1.0"));
