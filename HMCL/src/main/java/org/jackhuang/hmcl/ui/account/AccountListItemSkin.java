...
public class AccountListItemSkin extends SkinBase<AccountListItem> {
    ...
    public AccountListItemSkin(AccountListItem skinnable) {
        ...
        if (skinnable.getAccount().isPortable()) {
            btnMove.setGraphic(SVG.EARTH.createIcon(Theme.blackFillBinding(), -1, -1));
            runInFX(() -> FXUtils.installFastTooltip(btnMove, i18n("account.move_to_global")));
        } else {
            btnMove.setGraphic(SVG.EXPORT.createIcon(Theme.blackFillBinding(), -1, -1));
        ...
        btnRefresh.setGraphic(SVG.REFRESH.createIcon(Theme.blackFillBinding(), -1, -1));
        ...
        btnUpload.setGraphic(SVG.HANGER.createIcon(Theme.blackFillBinding(), -1, -1));
        ...
        btnCopyUUID.setGraphic(SVG.COPY.createIcon(Theme.blackFillBinding(), -1, -1));
        ...
        btnRemove.setGraphic(SVG.DELETE.createIcon(Theme.blackFillBinding(), -1, -1));
