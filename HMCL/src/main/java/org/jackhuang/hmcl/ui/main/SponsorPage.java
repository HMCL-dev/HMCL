...
public class SponsorPage extends StackPane {
    ...
    private void loadSponsorList() {
        Task.<List<Sponsor>>supplyAsync(() -> HttpRequest.GET("https://cdn.jsdelivr.net/gh/huanghongxun/HMCL@latest/sponsor/sponsor.json").getJson(new TypeToken<List<Sponsor>>() {
