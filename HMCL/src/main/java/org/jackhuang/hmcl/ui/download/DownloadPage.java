...
public class DownloadPage extends DecoratorAnimatedPage implements DecoratorPage {
    ...
    public DownloadPage(String uploadVersion) {
        ...
        shaderTab.setNodeSupplier(loadVersionFor(() -> HMCLLocalizedDownloadListPage.ofShaderPack((profile, version, file, addon) -> download(profile, version, file, "shaderpacks"), true)));
