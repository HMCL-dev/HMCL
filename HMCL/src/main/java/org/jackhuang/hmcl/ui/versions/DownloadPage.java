...
//                            }
    ...
    private static final class ModItem extends StackPane {
        ...
        ModItem(RemoteMod.Version dataItem, DownloadPage selfPage) {
            ...
            saveAsButton.setGraphic(SVG.CONTENT_SAVE_MOVE_OUTLINE.createIcon(Theme.blackFillBinding(), -1, -1));
            ...
            switch (dataItem.getVersionType()) {
                case Release:
                    graphicPane.getChildren().setAll(SVG.RELEASE_CIRCLE_OUTLINE.createIcon(Theme.blackFillBinding(), 24, 24));
                    content.getTags().add(i18n("version.game.release"));
                    break;
                case Beta:
                    graphicPane.getChildren().setAll(SVG.BETA_CIRCLE_OUTLINE.createIcon(Theme.blackFillBinding(), 24, 24));
                    content.getTags().add(i18n("version.game.snapshot"));
                    break;
                case Alpha:
                    graphicPane.getChildren().setAll(SVG.ALPHA_CIRCLE_OUTLINE.createIcon(Theme.blackFillBinding(), 24, 24));
                    content.getTags().add(i18n("version.game.snapshot"));
                    break;
            }
