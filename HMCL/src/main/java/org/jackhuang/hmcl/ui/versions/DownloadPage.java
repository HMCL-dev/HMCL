...

                {
                    ...
                    switch (dataItem.getVersionType()) {
                        case Alpha:
                            ...
                            graphicPane.getChildren().setAll(SVG.ALPHA_CIRCLE.createIcon(Theme.blackFill(), 24, 24));
                            break;
                        case Beta:
                            content.getTags().add(i18n("mods.channel.beta"));
                            graphicPane.getChildren().setAll(SVG.BETA_CIRCLE.createIcon(Theme.blackFill(), 24, 24));
                            break;
                        case Release:
                            content.getTags().add(i18n("mods.channel.release"));
                            graphicPane.getChildren().setAll(SVG.RELEASE_CIRCLE.createIcon(Theme.blackFill(), 24, 24));
                            break;
                    }
