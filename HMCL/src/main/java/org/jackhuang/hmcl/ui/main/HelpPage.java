...
public class HelpPage extends SpinnerPane {
    ...
    private void loadHelp() {
        showSpinner();
        Task.<List<HelpCategory>>supplyAsync(() -> HttpRequest.GET("https://cdn.jsdelivr.net/gh/zkitefly/help-content/help-content/help.json").getJson(new TypeToken<List<HelpCategory>>() {
        }.getType()))
