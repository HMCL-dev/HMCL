...
@Immutable
public class CurseMod implements RemoteMod.IMod {
    ...
    private final List<CurseVersionImpl> curseVersionImpls;
    ...
    public List<CurseVersionImpl> getLatestFiles() {
    ...
    public List<RemoteMod> loadDependencies(RemoteModRepository modRepository) throws IOException {
        Set<Integer> dependencies = curseVersionImpls.stream()
                .flatMap(curseVersionImpl -> curseVersionImpl.getDependencies().stream())
     ...
     */
    @Immutable
    public static class CurseVersionImpl implements RemoteMod.IVersion {
        private final int id;
        private final int gameId;
        private final int modId;
        private final boolean isAvailable;
        ...
        public CurseVersionImpl(int id, int gameId, int modId, boolean isAvailable, String displayName, String fileName, int releaseType, int fileStatus, List<LatestFileHash> hashes, Date fileDate, int fileLength, int downloadCount, String downloadUrl, List<String> gameVersions, List<Dependency> dependencies, int alternateFileId, boolean isServerPack, long fileFingerprint) {
            this.id = id;
            this.gameId = gameId;
            this.modId = modId;
            this.isAvailable = isAvailable;
        ...
        public RemoteMod.ModType getModType() {
            return RemoteMod.ModType.CURSEFORGE;
        }

        @Override
        public RemoteMod getRemoteMod() throws IOException {
            return CurseRemoteModRepository.MODS.getModById(Integer.toString(this.getModId()));
        }
