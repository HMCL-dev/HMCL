...
public final class RemoteMod {
    ...
    public static class Version {
        ...
        public Version(IVersion self, String versionId, String modid, String name, String version, Instant datePublished, VersionType versionType, File file, List<Dependency> dependencies, List<String> gameVersions, List<ModLoaderType> loaders) {
