 ...
 * @author huangyuhui
 */
public abstract class FabricLikeInstallTask extends Task<GameInstancePatch> {
    ...
    public FabricLikeInstallTask(DefaultDependencyManager dependencyManager, GameInstanceManifest manifest, ComponentRemoteVersion remoteVersion) {
    ...
    protected GameInstancePatch getPatch(FabricInfo fabricInfo, String gameVersion, String loaderVersion) {
        ...
        return new GameInstancePatch(getComponentType().getPatchId(), loaderVersion, GameInstancePatch.PRIORITY_LOADER, arguments, mainClass, libraries);
    }

    protected abstract GameComponentType getComponentType();
