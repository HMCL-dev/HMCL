...
public final class QuiltVersionList extends FabricLikeVersionList<QuiltRemoteVersion> {
    ...
    protected String getGameMetaURL() {
        return "https://meta.quiltmc.org/v3/versions/game";
    }
    ...
    @Override
    protected QuiltRemoteVersion createRemoteVersion(String gameVersion, String loaderVersion, List<String> urls) {
        return new QuiltRemoteVersion(gameVersion, loaderVersion, urls);
    }
}
