...
public class ForgeNewInstallProfile implements Validation {
     ...
     *          <p>Can be in the following formats:
     *          <p>* [value]: An artifact path.
     *          <p>* 'value': A string literal.
     *          <p>* value: A file in the installer package, to be extracted to a temp folder, and then have the absolute path in replacements
     */
