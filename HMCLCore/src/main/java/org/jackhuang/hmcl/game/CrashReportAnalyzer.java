...
public final class CrashReportAnalyzer {
    ...
    public enum Rule {
        ...
        JVM_32BIT(Pattern.compile("(Could not reserve enough space for 1048576KB object heap|Could not reserve enough space for 2097152KB object heap|The specified size exceeds the maximum representable size)")),
