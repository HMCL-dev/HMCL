...
public class Version implements Comparable<Version>, Validation {
    ...
    public AssetIndexInfo getAssetIndex() {
        ...
        if (assetIndex == null) {
            String hash = switch (assetsId) {
                case "1.8" -> "f6ad102bcaa53b1a58358f16e376d548d44933ec";
                case "14w31a" -> "10a2a0e75b03cfb5a7196abbdf43b54f7fa61deb";
                case "14w25a" -> "32ff354a3be1c4dd83027111e6d79ee4d701d2c0";
                case "1.7.4" -> "545510a60f526b9aa8a38f9c0bc7a74235d21675";
                case "1.7.10" -> "1863782e33ce7b584fc45b037325a1964e095d3e";
                case "1.7.3" -> "f6cf726f4747128d13887010c2cbc44ba83504d9";
                case "pre-1.6" -> "3d8e55480977e32acd9844e545177e69a52f594b";
                default -> {
                    assetsId = "legacy";
                    yield "770572e819335b6c0a053f8378ad88eda189fc14";
                }
            };
