 ...
 */
public final class DefaultVersionNumber implements VersionNumber<DefaultVersionNumber> {

    public static DefaultVersionNumber asVersion(String version) {
        Objects.requireNonNull(version);
        return new DefaultVersionNumber(version);
    }
    ...
    public static String normalize(String str) {
        return new DefaultVersionNumber(str).getCanonical();
    }
    ...
    private DefaultVersionNumber(String version) {
        this.value = version;
    ...
    // For simple version
    private DefaultVersionNumber(String version, ListItem items) {
        this.value = version;
        this.items = items;
    ...
    public int compareTo(String o) {
        return compareTo(DefaultVersionNumber.asVersion(o));
    }

    @Override
    public int compareTo(DefaultVersionNumber o) {
    ...
    public DefaultVersionNumber min(DefaultVersionNumber that) {
        return this.compareTo(that) <= 0 ? this : that;
    }

    public DefaultVersionNumber max(DefaultVersionNumber that) {
        return this.compareTo(that) >= 0 ? this : that;
    }

    @Override
    public boolean equals(Object o) {
        return o instanceof DefaultVersionNumber && canonical.equals(((DefaultVersionNumber) o).canonical);
    }
