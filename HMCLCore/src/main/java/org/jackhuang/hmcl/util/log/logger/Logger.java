 ...
 */
package org.jackhuang.hmcl.util.log.logger;

import java.util.HashMap;
import java.util.Map;
import java.util.concurrent.ConcurrentHashMap;
import org.jackhuang.hmcl.util.log.AppenderControl;
import org.jackhuang.hmcl.util.log.Configuration;
import org.jackhuang.hmcl.util.log.Level;
import org.jackhuang.hmcl.util.log.LogEvent;
import org.jackhuang.hmcl.util.log.appender.IAppender;
import org.jackhuang.hmcl.util.log.message.IMessage;
import org.jackhuang.hmcl.util.log.message.IMessageFactory;
