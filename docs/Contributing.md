...
|                             | `-Dhmcl.update.disable=<true/false>`         | Specifies whether to disable HMCL update checking                   | `false`                                                                                                      |
|                             | `-Dhmcl.update.packageManager=<name>`        | Specifies the name of the package manager that manages HMCL updates |                                                                                                              |