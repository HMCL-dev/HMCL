...
**English** | 中文 ([简体](Contributing_zh_Hans.md), [繁體](Contributing_zh_Hant.md))
...
| `HMCL_NATIVE_DECORATION`    | `-Dhmcl.nativeDecoration=<true/false/auto>`  | Specifies whether to use the system's native window decoration | `auto`                                                                                                       |                                                                  |
