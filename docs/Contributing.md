...
|                             | `-Dhmcl.uptate.disable=<true/false>`         | Specifies whether to disable HMCL update checking                   | `false`                                                                                                      |
|                             | `-Dhmcl.uptate.packageManager=<name>`        | Specifies the name of the package manager that manages HMCL updates |                                                                                                              |