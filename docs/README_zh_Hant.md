...
HMCLPP 是一款開源、跨平臺的 Minecraft 啟動器，支援模組管理、遊戲客製化、遊戲自動安裝 (Forge、NeoForge、Cleanroom、Fabric、Legacy Fabric、Quilt、LiteLoader 和 OptiFine)、模組包建立、介面客製化等功能。

HMCLPP 有著強大的跨平臺能力。它不僅支援 Windows、Linux、macOS、FreeBSD 等常見的作業系統，同時也支援 x86、ARM、RISC-V、MIPS、LoongArch 等不同的 CPU 架構。你可以使用 HMCLPP 在不同平臺上輕鬆地遊玩 Minecraft。

如果你想要了解 HMCLPP 對不同平臺的支援程度，請參見 [此表格](PLATFORM_zh_Hant.md)。

## 參與貢獻

HMCLPP 是一個由社群驅動的開源專案，歡迎任何人參與貢獻程式碼或提出建議。

你可以透過以下方式參與 HMCLPP 的開發：

- 透過在 GitHub 上[建立 Issue](https://github.com/deepsleep-v3/HMCLPP/issues/new/choose) 來回報 Bug 或提出功能請求。
- ……

在參與貢獻前，請閱讀[貢獻指南](./Contributing_zh_Hant.md)，其中包含以下內容：

- [如何從原始碼構建並開啟 HMCLPP](./Contributing_zh_Hant.md#構建-hmclpp)
- [透過除錯選項調整 HMCLPP 的行為](./Contributing_zh_Hant.md#除錯選項)

## 貢獻者

自 2015 年以來，HMCLPP 已經有超過 110 位貢獻者參與其中，感謝他們的辛勤付出！
